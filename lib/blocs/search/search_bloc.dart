...
import 'package:maps_app/models/list_route_map_model.dart';
...
class SearchBloc extends Bloc<SearchEvent, SearchState> {
  List<ListRouterMap> routerMapList = [
    ListRouterMap(title: "Rembo Shuttle", subTitle: "Ruta de evacuacion", time: DateTime.now(), 300),
  ];
