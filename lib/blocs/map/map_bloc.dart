...
class MapBloc extends Bloc<MapEvent, MapState> {
  ...
  Future drawRoutePolyline(RouteDestination destination) async {
    ...
    await TrafficService().registerRoutesList(
      RouteModel(
        title: destination.endPlace.text,
        description: destination.endPlace.type,
        startLatitude: destination.points.first.latitude,
        startLongitude: destination.points.first.longitude,
        destinationLatitude: destination.points.last.latitude,
        destinationLongitude: destination.points.last.longitude,
      ),
    );
